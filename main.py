...
if __name__ == '__main__':
    ...
    from push_cylindrical import push_cyl
    ...
    for n in range(Ntime_steps):
      ...
      # draw_particles_3D(x1,'magenta',fig_cart,ax_cart)
       ...
       hist[n,:,:] = x1.T
       x,v = x1.T,v1.T
    multi_particles_3D(hist,'1particle_Er_vth1_')
    qq = 0